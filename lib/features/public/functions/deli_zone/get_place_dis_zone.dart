...
List<PointDistanceModel> getPlaceDisZone(LatLng currentPos, List<PlaceModel> placeList) {
...
List<PointDistanceModel> sortPlaceDisZone(LatLng currentPos, List<PlaceModel> placeList) {
  List<PointDistanceModel> newPointDisData = getPlaceDisZone(currentPos, placeList);
